...
#define CHA_NUM_MS_DECONUM_SHIFT	24 /* legacy definition */
...
struct caam_perfmon {
	...
	u32 ib_dec_bytes;	/* PC_IB_DECRYPT - Inbound Bytes Decrypted   */
	u32 ib_valid_bytes;	/* PC_IB_VALIDATED Inbound Bytes Validated   */
	u64 rsvd[13];
